...
double, and String. Assign the following values to them false, “Palo Alto, CA”, 32767, 2000000000, 0.1234567891011, 0.5f,
 919827112351L, 127, ‘c’. Try to assign 32768 to short and see what happens.
 */

public class ThreeAssignVariables {
    public static void main(String[] args) {
        boolean isTrue = false;
        String string = "Palo Alto, CA";
        short shortNumber = 32767;
        int intNumber = 2000000000;
        double doubleNumber = 0.123456789011;
