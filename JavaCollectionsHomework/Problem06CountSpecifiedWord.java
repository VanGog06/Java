...
Java is a set of several computer software products and specifications          2
from Oracle Corporation that provides a system for developing application
software and deploying it in a cross-platform computing environment. Java
is used in a wide variety of computing platforms from embedded devices and
...
public class Problem06CountSpecifiedWord {
    public static void main(String[] args) {
        ...
        String pattern = "(?i)\\b" + sc.nextLine() + "\\b";
        int counter = 0;
